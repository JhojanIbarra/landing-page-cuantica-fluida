...
const TWEAK_DEFAULTS = /*EDITMODE-BEGIN*/{
  "accentColor": "#4B1FA3",
  "violetIntense": "#6D28D9",
  "purpleMid": "#7E22CE",
  "fuchsiaVibrant": "#E2188A",
  "softBg": "#FFFDFE"
}/*EDITMODE-END*/;
...
function App() {
  ...
  return (
    <main className="page">
      <style>{`
        *{box-sizing:border-box} html{scroll-behavior:smooth} body{margin:0;background:var(--ocd-tweak-soft-bg,#FFFDFE);color:#4B4B55;font-family:"DM Sans","Helvetica Neue",system-ui,sans-serif} ::selection{background:rgba(233,213,255,.6)}
        .page{--bg:var(--ocd-tweak-soft-base,#FFFDFE);--accent:var(--ocd-tweak-primary-deep,#4B1FA3);--violet:var(--ocd-tweak-violet-intense,#6D28D9);--purple:var(--ocd-tweak-purple-mid,#7E22CE);--fuchsia:var(--ocd-tweak-fuchsia,#E2188A);--text:#4B4B55;--muted:#4B4B55;background:radial-gradient(circle at 14% 8%,rgba(233,213,255,.65),transparent 34rem),radial-gradient(circle at 88% 18%,rgba(248,189,217,.42),transparent 28rem),linear-gradient(180deg,#ffffff 0%,#fffdfe 44%,#fdf8ff 100%);min-height:100vh;overflow:hidden}
        .nav{position:fixed;inset:0 0 auto;z-index:20;height:70px;padding:0 clamp(18px,4vw,38px);display:flex;align-items:center;justify-content:space-between;background:${scrolled ? 'rgba(255,253,254,.9)' : 'transparent'};backdrop-filter:${scrolled ? 'blur(18px)' : 'none'};box-shadow:${scrolled ? '0 1px 0 rgba(75,31,163,.12)' : 'none'};transition:.25s}.logo{font-family:Georgia,serif;font-size:1.35rem;letter-spacing:-.02em}.nav button,.cta{border:0;border-radius:999px;background:linear-gradient(135deg,var(--accent) 0%,var(--purple) 45%,var(--fuchsia) 100%);color:white;font-weight:800;cursor:pointer;box-shadow:0 14px 34px rgba(109,40,217,.28);transition:.2s;text-decoration:none}.nav button{padding:.72rem 1.15rem}.cta{display:inline-flex;padding:1.08rem 1.9rem;font-size:1rem}.cta:hover,.nav button:hover{transform:translateY(-2px);box-shadow:0 18px 42px rgba(226,24,138,.34)}.section{max-width:1120px;margin:auto;padding:clamp(70px,9vw,112px) clamp(20px,4vw,34px)}.hero{padding-top:150px;text-align:center;position:relative}.eyebrow{display:inline-flex;align-items:center;gap:.55rem;border:1px solid rgba(126,34,206,.22);background:rgba(255,255,255,.58);color:var(--accent);border-radius:999px;padding:.46rem .9rem;text-transform:uppercase;letter-spacing:.12em;font-size:.74rem;font-weight:800}.dot{width:.46rem;height:.46rem;border-radius:50%;background:var(--fuchsia);box-shadow:0 0 0 6px rgba(226,24,138,.18)}h1,h2,h3{font-family:Georgia,"DM Serif Display",serif;font-weight:400;color:#4B1FA3;letter-spacing:-.035em}h1{font-size:clamp(2.55rem,7vw,5.1rem);line-height:1.02;margin:1.25rem auto .55rem;max-width:940px}.hero-subtitle{font-family:Georgia,"DM Serif Display",serif;font-size:clamp(1.35rem,3.4vw,2.2rem);line-height:1.2;letter-spacing:-.02em;color:var(--accent);margin:0 auto 1.25rem;max-width:780px}h2{font-size:clamp(2rem,5vw,3.45rem);line-height:1.08;margin:0 0 1rem}.typewriter{display:inline-block;overflow:hidden;white-space:nowrap;border-right:2px solid rgba(226,24,138,.85);max-width:100%;animation:typing 3.2s steps(56,end) .15s both,caretBlink .75s step-end infinite}.typewriter-done{border-right:0}@keyframes typing{from{width:0}to{width:100%}}@keyframes caretBlink{50%{border-color:transparent}}h3{font-size:clamp(1.25rem,3vw,1.75rem);line-height:1.18;margin:.2rem 0 .75rem}p{font-size:1.04rem;line-height:1.75;color:var(--muted)}.lead{font-size:clamp(1.08rem,2vw,1.28rem);max-width:760px;margin:0 auto 2.1rem}.sealrow{display:grid;grid-template-columns:repeat(3,minmax(0,1fr));gap:16px;margin:2.2rem auto 0;max-width:920px}.seal,.card{background:linear-gradient(170deg,rgba(255,255,255,.97) 0%,rgba(233,213,255,.2) 100%);border:1px solid rgba(126,34,206,.22);box-shadow:0 18px 50px rgba(75,31,163,.08),0 2px 0 rgba(255,255,255,.8) inset;border-radius:22px}.seal{padding:1rem;font-weight:700;color:var(--text)}.split{display:grid;grid-template-columns:minmax(0,1fr) minmax(0,1fr);gap:22px;align-items:start;max-width:1040px}.card{padding:clamp(24px,4vw,38px);position:relative;overflow:visible;isolation:isolate}.card::before{content:"";position:absolute;inset:0;background:linear-gradient(120deg,rgba(233,213,255,.24),rgba(248,187,217,0) 46%);opacity:.62;pointer-events:none;border-radius:22px;z-index:1}.card::after{content:"";position:absolute;width:220px;height:220px;border-radius:50%;background:radial-gradient(circle,rgba(226,24,138,.24) 0%,rgba(233,213,255,.22) 34%,rgba(226,24,138,0) 74%);pointer-events:none;filter:blur(3px);z-index:-1}.card>*{position:relative;z-index:2}.card:nth-of-type(3n+1)::after{left:-62px;top:-58px}.card:nth-of-type(3n+2)::after{right:-70px;top:22%}.card:nth-of-type(3n)::after{left:28%;bottom:-88px}.card{box-shadow:0 30px 76px rgba(75,31,163,.12),0 10px 24px rgba(226,24,138,.08),0 2px 0 rgba(255,255,255,.8) inset}.painlist{display:grid;gap:12px;margin:1.2rem 0}.painlist li{list-style:none;display:flex;gap:.7rem;color:var(--text);font-weight:650}.check{color:var(--accent);font-weight:900}.compare{display:grid;grid-template-columns:repeat(2,minmax(0,1fr));gap:18px;margin-top:2rem;max-width:1040px;margin-inline:auto}.comparecol{border-radius:24px;overflow:hidden;background:linear-gradient(180deg,#fff 0%,#fdf8ff 100%);border:1px solid rgba(126,34,206,.2);box-shadow:0 20px 44px rgba(75,31,163,.1)}.comparecol h3{padding:1rem 1.2rem;margin:0;font-family:inherit;font-size:.86rem;letter-spacing:.14em;text-transform:uppercase;font-weight:900}.comparecol:first-child h3{background:linear-gradient(135deg,rgba(139,115,85,.22),rgba(61,46,30,.14));color:#4a3522}.comparecol.after{position:relative;z-index:1;background:linear-gradient(160deg,rgba(255,255,255,.96) 0%,rgba(233,213,255,.28) 100%);border-color:rgba(126,34,206,.34);box-shadow:0 24px 56px rgba(109,40,217,.22),0 0 0 1px rgba(233,213,255,.26)}.comparecol.after::before{content:"";position:absolute;inset:-26px -20px -30px -20px;z-index:-1;border-radius:36px;background:radial-gradient(circle at 50% 58%,rgba(212,168,83,.58) 0%,rgba(233,213,255,.42) 42%,rgba(212,168,83,0) 74%);filter:blur(16px);pointer-events:none}.comparecol.after>*{position:relative;z-index:1}.comparecol.after h3{background:linear-gradient(135deg,rgba(75,31,163,.9),rgba(226,24,138,.88));color:#fff;text-shadow:0 1px 2px rgba(75,31,163,.32)}.comparecol p{margin:0;padding:1rem 1.2rem;border-top:1px solid rgba(184,134,11,.12);font-size:.98rem;color:#4B4B55}.comparecol.after p{border-top:1px solid rgba(184,134,11,.2);color:#4B4B55;font-weight:560}.grid3{display:grid;grid-template-columns:repeat(3,minmax(0,1fr));gap:18px;max-width:1040px;margin-inline:auto}.num{width:38px;height:38px;border-radius:50%;display:grid;place-items:center;background:rgba(233,213,255,.62);color:var(--accent);font-weight:900;margin-bottom:1rem}.phases{display:grid;gap:14px;margin-top:1.5rem}.phase{display:grid;grid-template-columns:92px 1fr;gap:18px;align-items:center;padding:1.08rem 1.2rem;background:linear-gradient(170deg,rgba(255,255,255,.98) 0%,rgba(255,250,240,.94) 100%);border:1px solid rgba(184,134,11,.2);border-radius:20px;position:relative;overflow:visible;isolation:isolate;box-shadow:0 24px 62px rgba(61,46,30,.14),0 8px 20px rgba(61,46,30,.1),0 2px 0 rgba(255,255,255,.82) inset}.phase::before{content:"";position:absolute;inset:0;border-radius:20px;background:linear-gradient(120deg,rgba(212,168,83,.18),rgba(212,168,83,0) 48%);opacity:.7;pointer-events:none;z-index:1}.phase::after{content:"";position:absolute;width:220px;height:220px;border-radius:50%;background:radial-gradient(circle,rgba(212,168,83,.36) 0%,rgba(212,168,83,.17) 34%,rgba(212,168,83,0) 74%);filter:blur(4px);pointer-events:none;z-index:-1}.phase>*{position:relative;z-index:2}.phase:nth-child(3n+1)::after{left:-62px;top:-58px}.phase:nth-child(3n+2)::after{right:-72px;top:24%}.phase:nth-child(3n)::after{left:28%;bottom:-90px}.phase strong{color:var(--accent);font-size:.98rem;letter-spacing:.02em}.bonusgrid{display:grid;grid-template-columns:repeat(2,minmax(0,1fr));gap:18px;max-width:1040px;margin-inline:auto}.testgrid{display:grid;grid-template-columns:repeat(2,minmax(0,1fr));gap:18px;max-width:1040px;margin-inline:auto}.value{color:var(--accent);font-weight:900}.quote{position:relative}.quote:before{content:'“';position:absolute;right:24px;top:8px;font-family:Georgia,serif;font-size:4rem;color:rgba(212,168,83,.28)}.pricebox{max-width:720px;margin:2rem auto 0;text-align:center;background:white;border:1px solid rgba(184,134,11,.16);border-radius:30px;padding:clamp(28px,5vw,48px);box-shadow:0 24px 80px rgba(61,46,30,.08)}.price{font-family:Georgia,serif;font-size:clamp(3rem,8vw,5rem);color:var(--accent);line-height:1}.strike{text-decoration:line-through;color:var(--muted);font-size:1.2rem}.faq{max-width:860px;margin:2rem auto 0;display:grid;gap:12px}.faq button{width:100%;display:flex;justify-content:space-between;gap:16px;padding:1.1rem 1.25rem;background:white;border:1px solid rgba(184,134,11,.14);border-radius:16px;text-align:left;color:var(--text);font-weight:800;cursor:pointer}.faq p{background:white;margin:-12px 0 0;padding:0 1.25rem 1.25rem;border:1px solid rgba(184,134,11,.14);border-top:0;border-radius:0 0 16px 16px}.center{text-align:center}.soft{background:linear-gradient(180deg,rgba(212,168,83,.06),rgba(255,255,255,.18))}.final{max-width:760px;text-align:center}.fine{font-size:.9rem}.focus:focus-visible,button:focus-visible{outline:3px solid rgba(184,134,11,.35);outline-offset:3px}.keygold{color:var(--accent);font-weight:800;text-shadow:0 1px 0 rgba(255,255,255,.35)}.guarantee-card{position:relative;background:linear-gradient(160deg,#fffefb 0%,#fff6e6 52%,#fffdf7 100%);border:1px solid rgba(184,134,11,.34);box-shadow:0 34px 90px rgba(61,46,30,.18),0 0 0 1px rgba(212,168,83,.22) inset}.guarantee-card::before{content:"";position:absolute;inset:-34px -26px -38px;z-index:-1;border-radius:34px;background:radial-gradient(circle at 64% 42%,rgba(212,168,83,.58) 0%,rgba(212,168,83,.25) 44%,rgba(212,168,83,0) 76%);filter:blur(22px);pointer-events:none}.guarantee-badge{display:inline-flex;align-items:center;gap:.5rem;padding:.4rem .85rem;border-radius:999px;background:rgba(184,134,11,.14);border:1px solid rgba(184,134,11,.3);color:var(--accent);font-size:.76rem;font-weight:900;letter-spacing:.08em;text-transform:uppercase}.guarantee-title{font-size:clamp(1.4rem,3.2vw,2rem);margin:.9rem 0 .6rem;color:#4a3522}.guarantee-points{display:grid;gap:.66rem;margin:1rem 0 1.2rem;padding:0}.guarantee-points li{list-style:none;display:flex;gap:.58rem;font-weight:700;color:#4a3522}.guarantee-points .check{font-size:1.02rem}.guarantee-note{margin-top:.3rem;padding:.8rem .9rem;border-radius:14px;background:rgba(255,255,255,.62);border:1px dashed rgba(184,134,11,.36);color:#654a2f;font-weight:650}@keyframes rise{from{opacity:0;transform:translateY(18px)}to{opacity:1;transform:none}}.hero>*{animation:rise .7s ease both}.hero>*:nth-child(2){animation-delay:.08s}.hero>*:nth-child(3){animation-delay:.16s}.hero>*:nth-child(4){animation-delay:.24s}
        .reveal-section{opacity:0;transform:translateY(42px);filter:blur(14px);transition:opacity 1.6s cubic-bezier(.2,.9,.2,1),transform 1.6s cubic-bezier(.2,.9,.2,1),filter 1.9s ease}.reveal-section.is-visible{opacity:1;transform:none;filter:none}.reveal-section :is(h1,h2,h3,p,li,strong,a,.eyebrow,.seal){opacity:0;transform:translateY(18px);filter:blur(10px);transition:opacity 1.8s cubic-bezier(.16,.95,.2,1),transform 1.8s cubic-bezier(.16,.95,.2,1),filter 2.2s ease}.reveal-section.is-visible :is(h1,h2,h3,p,li,strong,a,.eyebrow,.seal){opacity:1;transform:none;filter:blur(0)}.reveal-section.is-visible :is(h1,h2,h3){transition-delay:.18s}.reveal-section.is-visible :is(p,li){transition-delay:.34s}.reveal-section.is-visible :is(a,.seal){transition-delay:.46s}.card,.seal,.phase,.comparecol,.pricebox{transition:transform .32s cubic-bezier(.2,.8,.2,1),box-shadow .32s cubic-bezier(.2,.8,.2,1),border-color .28s ease,filter .32s ease}.card:hover,.seal:hover,.phase:hover,.comparecol:hover{transform:translateY(-6px) scale(1.01);box-shadow:0 28px 88px rgba(126,34,206,.14),0 0 0 1px rgba(233,213,255,.55) inset;border-color:rgba(226,24,138,.28);filter:saturate(1.04)}.pricebox{animation:softGlow 4.8s ease-in-out infinite}.dot{animation:pulseGold 2.8s ease-in-out infinite}.faq button span:last-child{transition:transform .22s ease}.faq button[aria-expanded="true"] span:last-child{transform:rotate(180deg)}.faq p{animation:faqOpen .24s ease both}.phase:nth-child(2n),.bonusgrid .card:nth-child(2n),.testgrid .card:nth-child(2n){transition-delay:.05s}.grid3 .card:nth-child(3n+2),.comparecol.after{transition-delay:.08s}.grid3 .card:nth-child(3n),.phase:nth-child(3n){transition-delay:.12s}@keyframes softGlow{0%,100%{box-shadow:0 24px 80px rgba(126,34,206,.08),0 0 0 rgba(226,24,138,0)}50%{box-shadow:0 26px 92px rgba(126,34,206,.1),0 0 42px rgba(226,24,138,.16)}}@keyframes pulseGold{0%,100%{box-shadow:0 0 0 6px rgba(233,213,255,.55)}50%{box-shadow:0 0 0 10px rgba(248,187,217,.28)}}@keyframes faqOpen{from{opacity:0;transform:translateY(-6px)}to{opacity:1;transform:none}}.comparecol.after,.bonusgrid .card,.grid3 .card,.phase,.guarantee-card{border-color:rgba(233,213,255,.72)!important;box-shadow:0 28px 74px rgba(126,34,206,.12),0 10px 28px rgba(226,24,138,.08),0 0 0 1px rgba(233,213,255,.62) inset!important}.comparecol.after{background:linear-gradient(145deg,rgba(255,253,254,.98),rgba(248,187,217,.2))!important}.comparecol.after::before,.comparecol.after::after,.bonusgrid .card::before,.bonusgrid .card::after,.grid3 .card::before,.grid3 .card::after,.phase::before,.phase::after,.guarantee-card::before,.guarantee-card::after{background:radial-gradient(circle,rgba(226,24,138,.18) 0%,rgba(233,213,255,.34) 42%,rgba(226,24,138,0) 72%)!important}.comparecol.after:hover,.bonusgrid .card:hover,.grid3 .card:hover,.phase:hover,.guarantee-card:hover{border-color:rgba(226,24,138,.34)!important;box-shadow:0 30px 88px rgba(126,34,206,.16),0 12px 32px rgba(247,37,133,.1),0 0 0 1px rgba(248,187,217,.56) inset!important}.guarantee-badge,.bonusgrid .eyebrow{background:rgba(248,187,217,.28)!important;border-color:rgba(226,24,138,.22)!important;color:#4B1FA3!important}@media (prefers-reduced-motion: reduce){*,*::before,*::after{animation-duration:.01ms!important;animation-iteration-count:1!important;scroll-behavior:auto!important;transition-duration:.01ms!important}.reveal-section{opacity:1;transform:none;filter:none}}@media(max-width:820px){.sealrow,.split,.compare,.grid3,.bonusgrid,.testgrid{grid-template-columns:1fr}.hero{padding-top:120px}.phase{grid-template-columns:1fr}.nav{height:64px}.nav button{display:none}.section{padding-block:68px}}
      `}</style>
      ...
      <section {...reveal('hero', 'hero')}>
        ...
        <a className="cta focus" href="https://pay.hotmart.com/Q105971658D">Quiero reprogramarme ahora</a>
